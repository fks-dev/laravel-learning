...
<body>
    <div class="mt-3 container">
        ...
        <div class="border">
            <div class="p-2 bg-secondary text-white">インポート</div>
            <div class="m-3">
                <ul>
                    ...
                    <li class="mb-2">パスワードは初期値（admin）が設定されます。</li>
                ...
                <form action="{{ route('admin.admin-management.store-csv') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="ms-3">
